...
def load_benchmark(
    ...
    # Force forward slashes — the submodule splits on '/' to derive block_name,
    # which breaks on Windows paths with backslashes.
    plc = PlacementCost(netlist_file.replace("\\", "/"))
